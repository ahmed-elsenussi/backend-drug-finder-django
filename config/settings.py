...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-(i#2(cgjnxc@e0h89%0&)w0&)9^eua0@1osswo=5xv5ntip=&9')
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'drugfinderr@gmail.com' )
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'qqqp fsqc looe uvvq')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'drugfinderr@gmail.com' )  # Add this
SERVER_EMAIL = os.getenv('SERVER_EMAIL', 'drugfinderr@gmail.com' )  # For error emails
